...
- (void)viewDidLoad {
    ...
    UIImage *btnMenuImage = [UIImage imageNamed:@"menu"];
    [btnMenuImage imageTintedWithColor:kAppColor];

    UIBarButtonItem *barMenuItem = [[UIBarButtonItem alloc]initWithImage:btnMenuImage style:UIBarButtonItemStylePlain target:self action:@selector(btnMenuTouch)];
...
- (NSAttributedString *)titleForEmptyDataSet:(UIScrollView *)scrollView{
    NSString *text = @"View all your recent tracks here!";
